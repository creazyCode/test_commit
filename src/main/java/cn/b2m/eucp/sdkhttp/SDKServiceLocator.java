...
//    private java.lang.String SDKService_address = "http://116.58.219.223:8081/sdk/SDKService";
    	 ...
    	 private java.lang.String SDKService_address_Sms = "http://hprpt2.eucp.b2m.cn:8080/sdk/SDKService?wsdl";
    	 private java.lang.String SDKService_address = "http://voice.b2m.cn:8090/sdk/SDKService?wsdl";
    ...
    public cn.b2m.eucp.sdkhttp.SDKClient getSDKServiceSms() throws javax.xml.rpc.ServiceException {
    	java.net.URL endpoint;
    	try {
    		endpoint = new java.net.URL(SDKService_address_Sms);
    	}
    	catch (java.net.MalformedURLException e) {
    		throw new javax.xml.rpc.ServiceException(e);
    	}
