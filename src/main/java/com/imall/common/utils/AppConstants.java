...
public class AppConstants {
	...
	//逻辑：1.启动的时候把已经安装的所有app信息加载好，去掉微愿，去掉xposed相关的，分好类
    ...
    static{
        ...
        APP_XPOSED_RELATED.put("com.lixin.hardwarecode", "hardware code");
        APP_XPOSED_RELATED.put("com.sudocode.sudohide", "sudo hide");
        //APP_XPOSED_RELATED.put("com.snail.device", "snail device");
    ...
    static{
        ...
        APP_XMATOR_RELATED.put("com.rrt.lijilong.hardwareinfo", "JiLong Hardware Info");
    }
